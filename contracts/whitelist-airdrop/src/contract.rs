...
use astrohero::state::{Extension};
use astrohero::msg::{ExecuteMsg as AstroExcuteMsg};
...
pub fn execute(
    ...
    match msg {
        ...
        ExecuteMsg::Claim {
            ...
            proof,
            mint_msg
        } => execute_claim(deps, env, info, stage, amount, proof, mint_msg),
    }
}
...
pub fn execute_claim(
    ...
    let res = Response::new()
        ...
        .add_message(WasmMsg::Execute {
            ...
            funds: vec![],
            msg: to_binary(&AstroExcuteMsg::Mint(mint_msg))?,
        })
        .add_attributes(vec![
            attr("action", "claim"),
            attr("stage", stage.to_string()),
...
pub fn query_config(deps: Deps) -> StdResult<ConfigResponse> {
    ...
    Ok(ConfigResponse {
        ...
        nft_token_address: cfg.nft_token_address.to_string(),
        treasury: cfg.treasury.to_string(),

        collection_name: cfg.collection_name.to_string(),
         //collection symbol 
        collection_symbol: cfg.collection_symbol.to_string(),
...
mod tests {
    ...
    use cosmwasm_std::{from_binary, from_slice, coin};
    ...
    fn proper_instantiation() {
        ...
        let msg = InstantiateMsg {
            ...
            treasury: "owner0000".to_string(),
            nft_token_address: "anchor0000".to_string(),
            collection_name: "AstroCollection".to_string(),
            collection_symbol: "ASTRO".to_string(),
            price: coin(3, "tolken")
        };
        ...
        assert_eq!("owner0000", config.treasury.as_str());
        assert_eq!("anchor0000", config.nft_token_address.as_str());
        assert_eq!("AstroCollection", config.collection_name.as_str());
        assert_eq!("ASTRO", config.collection_symbol.as_str());
        assert_eq!(coin(3, "tolken"), config.price);
